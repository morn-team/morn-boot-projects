 ...
 */
public class DisplayableControllerSupport<T, I extends Serializable, S extends CrudService<T, I> & DisplayableService<T, I>> extends
    CrudControllerSupport<T, I, S> {
